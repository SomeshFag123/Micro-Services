...
# Student Services Dashboard – Microservices Prototype  
Name: Somesh Fageria  
Student ID: 23213921  
...
## Overview
This project is a simple prototype of a Student Services Dashboard developed using a microservices architecture.  
It demonstrates how independent services can run in isolation but still communicate through HTTP using Docker containers.  

The system consists of three lightweight Flask services that each have their own purpose and run on separate ports.  
All services are connected through a shared Docker network.  
This project was created for the INFS605 Microservices assignment, which contributes 40 percent to the final course grade.

---

## Services Included
Student Profile Service (Port 5001): Manages basic student information such as name, email, and programme.  
Course Catalogue Service (Port 5002): Provides a list of courses and allows new courses to be added.  
Feedback Service (Port 5003): Accepts course feedback and prints a notification message in the console when feedback is submitted.

---

## How to Run the System
1. Make sure Docker Desktop is installed and running on your computer.  
2. Open this project folder in Visual Studio Code or any terminal.  
